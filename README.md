...
<h2 align="center">  ONLY PAKISTANI WITHOUT LOGIN FB 07 DIGIT CRACK  </h2>

<p align="center">
      NO LOGIN ONLY PAKISTANI 07 DIGIT CRACK
</p>
...
$ pkg install git
$ git clone https://github.com/James404-cyber/Pak07.git
$ cd Pak07
$ python2 PAK07.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pkg install git; git clone https://github.com/James404-cyber/Pak07.git ; cd Pak07 ; python2 PAK07.py
```
